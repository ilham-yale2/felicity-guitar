                ...
                <div class="col-md-2 d-flex nav-filter">
                    <div class="col-10 px-0 mt-5 mt-md-0">
                        ...
                        <ul class="list-none mt-4 list-brand">
                            @if ($brands)    
                                ...
                                <li class="text-capitalize">
                                    <a class="filter text-gold" href="{{route('browse-category')}}?subject={{$subject}}&brd={{$item}}{{$ctg}}"><span class="text-country"><b>{{$item}}</b></span></a>
                                </li>
                                @endforeach
                        ...
                        <ul class="list-none brand-list mt-4 mb-3">
                            @if ($condition)
                                <li class="">
                                    <a class="filter" href="{{route('browse-category')}}?subject={{$subject}}{{$ctg}}&condition=new"><span>New</span></a>
                                </li>
                                <li class="mt-0">
                                    <a class="filter" href="{{route('browse-category')}}?subject={{$subject}}{{$ctg}}&condition=Used"><span>Used</span></a>
                                </li>
                            @endif
                            @if ($subject == 'Guitar')
                        ...
                        <div class="d-flex d-md-block">
                            ...
                            <ul class="mt-4 list-none brand-list ml-auto ml-md-0">
                                ...
                                <li class="pb-5">
                                    <a class="filter" href="{{route('browse-brand')}}?subject={{$subject}}{{$ctg}}&up_year=2020"><span>2020 - </span></a>
                                </li>
                            </ul>
                            @endif
                        </div>
