                        ...
                        <li class="has-sub position-relative"><a href="#">Browse by Category</a>
                            <div class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="<?php echo e(route('browse-category')); ?>?subject=Effects Pedals">Effects Pedals</a></li>
                                ...
                                <ul>
                                    <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($loop->iteration <= 12): ?>
                                            <li><a href="<?php echo e(route('browse-brand')); ?>?subject=<?php echo e($s); ?>&brd=<?php echo e($b->name); ?>"><?php echo e($b->name); ?></a></li>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
