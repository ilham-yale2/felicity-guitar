...
<?php $__env->startSection('content'); ?>
    <div class="col-md-2 col-4 position-fixed nav-about h-100 bg-dark">
        ...
        <div class="w-100">
            <ul class="nav-list">
                <li>
                    <a href="#service">Luthier Service</a>
                </li>
                <li>
    ...
    <div class="aboutus">
        <div class="container">
            ...
            <section class="welcome_message mt-5">
                <img src="<?php echo e(asset('images/Welcome-Banner.png')); ?>" class="text-center" alt="">
                <h3 class="text-center mt-3 copperplate">
                    OUR SITE IS STILL UNDER CONSTRUCTION, BUT PLEASE C’MON IN, HAVE A LOOK AROUND AND MAKE YOURSELF AT HOME !
                </h3>
                ...
                <p>
                    If you have any questions about the guitars or gear you see on our website; please don’t hesitate to call or email us. As well as selling, we also buy and trade fine guitars. For a full list of our “wish list” guitars, check out our Sell or Trade page.
                </p>
                <p>
            ...
            <section class="luthier_service" id="service">
                <h2 class="text-gold">LUTHIER SERVICE</h2>
                <p> We work on all plucked instruments and stringed instruments </p>
                <p>
                ...
                <h4 class="text-gold ">Acoustic Guitar Setups</h4>
                <p>
                ...
                <h3 class="text-gold text-underline">
                ...
                <table class="table text-white border-0" width="100%">
                    ...
                    <tr>
                        <td class="border-0 px-0 pb-0" width="30%">
                            lectric Guitar Setup, Strat style floating tremolo   
                        </td>
                        <td class="border-0 px-0 pb-0">
                            60.00
                        </td>
                ...
                <p>This includes the instrument’s body, neck and front & back of peghead. We use three-step non-silicone based polishing compounds to achieve best results. This does not include 			fretboard treatment and/or fret polishing which requires the removal –and sometimes replacement- of the strings.</p>
                <table class="table text-white border-0" width="100%">
                    <tr>
                        <td class="border-0 px-0 pb-0" width="30%">
                ...
                <p>We proudly stand by our work. <br>
            ...
            <section class="shop_policies mt-5 pt-3" id="shop_policies">
                ...
                <h3 class="text-gold mt-3">BUSSINESS HOURS</h3>
                ...
                <h2 class="text-gold mt-3">SALES</h2>
                <p>
                ...
                <h3 class="mt-3 text-uppercase text-gold">returns</h3>
                ...
                <h3 class="mt-3 text-uppercase text-gold">amplifiers sales</h3>
                ...
                <h2 class="text-gold text-uppercase">Shipping</h2>
                <h3 class="mt-3 text-uppercase text-gold">International shipping</h3>
                ...
                <h2 class="mt-3 text-uppercase text-gold">MISCELLANEOUS POLICIES</h2>
                <p>
                ...
                <p>
                    ...
                    <br> We are not responsible for typographical and/or written errors. 
                </p>
                <p class="mt-3" >
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\felicity-guitar\resources\views/about-us.blade.php ENDPATH**/ ?>